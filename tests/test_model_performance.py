...
def test_model_performance():
    """
    Testa o desempenho do modelo em termos de várias métricas de classificação.
    
    Verifica:
    - Acurácia, Precisão, Recall, F1 Score e ROC AUC do modelo.
    - Se as métricas de desempenho estão acima dos thresholds mínimos definidos.
    """
